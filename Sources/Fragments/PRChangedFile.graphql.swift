...
public struct PRChangedFile: TDGitGraphQL.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    #"fragment PRChangedFile on PullRequestChangedFile { __typename additions changeType deletions path viewerViewedState }"#
  }
